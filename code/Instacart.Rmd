...
# AUC (LDA)
roc_curve11 <- roc(test_data$reordered, as.numeric(lda.pred$class))
plot(roc_curve11, main = "ROC Curve", col = "blue")
auc11 <- auc(roc_curve11)
print(paste("AUC:", auc11))

# AUC (QDA)
roc_curve12 <- roc(test_data$reordered, as.numeric(qda.pred$class))
plot(roc_curve12, main = "ROC Curve", col = "blue")
auc12 <- auc(roc_curve12)
print(paste("AUC:", auc12))
```
...
# AUC Curve
roc_curve9 <- roc(knn_test_data$reordered, as.numeric(knn_model))
plot(roc_curve9, main = "ROC Curve", col = "blue")
auc9 <- auc(roc_curve9)
print(paste("AUC:", auc9))
...
# AUC Curve
roc_curve7 <- roc(test_data$reordered, as.numeric(tree.pred2))
plot(roc_curve7, main = "ROC Curve", col = "blue")
auc7 <- auc(roc_curve7)
print(paste("AUC:", auc7))
```
...
# AUC Curve
roc_curve5 <- roc(test_data$reordered, as.numeric(rf_preds))
plot(roc_curve5, main = "ROC Curve", col = "blue")
auc5 <- auc(roc_curve5)
print(paste("AUC:", auc5))
